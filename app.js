...
const PLAYERS = [
  { id: 0, name: 'Red', color: '#ff3d00', homeX: 1, homeY: 1, startTile: 0 },
  { id: 1, name: 'Green', color: '#00e676', homeX: 9, homeY: 1, startTile: 13 },
  { id: 2, name: 'Yellow', color: '#ffd600', homeX: 9, homeY: 9, startTile: 26 },
  { id: 3, name: 'Blue', color: '#2979ff', homeX: 1, homeY: 9, startTile: 39 }
];
